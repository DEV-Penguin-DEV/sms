    ...
    "function" == typeof define && define.amd
        ...
        : "object" == typeof module && module.exports
            ? (module.exports = function (e, t) {
                return void 0 === t && (t = "undefined" != typeof window ? require("js/jquery") : require("js/jquery")(e)), n(t), t;
            })
            : n(jQuery);
})(function (t) {
    var e,
                    ...
                    return (
                        n.Extend(i, t),
                            (i.prototype.render = function () {
                                ...
                                return e[0].classList.add("select2-selection--single"), e.html('<div class="select2-selection__rendered"></div><div class="select2-selection__arrow" role="presentation"><b role="presentation"></b></div>'), e;
                            }),
                    ...
                    return (
                        c.Extend(o, e),
                                ...
                                this.$selection.find(".select2-selection__rendered").attr("id", s),
                                    ...
                                    this.$selection.on("click", ".select2-selection__choice__remove", function (e) {
                                        ...
                                        $('.intro__filter').each(function (i,e){
                                            ...
                                            let indexOption = 1;
                                            $('.intro__filter:nth-child('+(index+1)+')').find('option:selected').each(function (ee, ii){
                                                let count = $(this).attr('data-count');
                                                if($('.intro__filter:nth-child(' + (index + 1) + ')').find('.select2-selection__choice:nth-child(' + indexOption + ') .select2-selection__choice__display i').length == 0){
                                                    if(count) {
                                                        $('<i>' + count + '</i>').appendTo($('.intro__filter:nth-child(' + (index + 1) + ')').find('.select2-selection__choice:nth-child(' + indexOption + ') .select2-selection__choice__display'))
                                                    }
                                                }
                                                indexOption++;
                                            })
                            ...
                            (o.prototype.selectionContainer = function () {
                                return i(
                                    '<li class="select2-selection__choice"><button type="button" class="select2-selection__choice__remove" tabindex="-1"><span aria-hidden="true" class="select2-selection__reset"></span></button><span class="select2-selection__choice__display"></span></li>'
                                );
                            }),
                            (o.prototype.update = function (e) {
